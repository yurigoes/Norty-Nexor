    ...
    >
      <defs>
        ...
        <linearGradient id={`${uid}-ground`} x1="0" y1="196" x2="0" y2="260" gradientUnits="userSpaceOnUse">
          <stop stopColor="#0C1A2C" />
          <stop offset="1" stopColor="#071120" />
        </linearGradient>
      </defs>

      {/* Malha de conexões da marca, bem ao fundo */}
      <g opacity="0.28" stroke="#20D5E8" strokeWidth="1" fill="#20D5E8">
      ...
      <g opacity="0.62">
        <rect x="286" y="98" width="104" height="102" rx="2" fill="#0E1D30" />
        <rect x="806" y="110" width="88" height="90" rx="2" fill="#0C1929" />
        {windows.map(([x, y, o], i) => (
      ...
      <line x1="0" y1="196" x2="900" y2="196" stroke="#1A2C42" strokeWidth="1.4" />
      ...
      <g>
        <path d="M580 200 L580 138 A68 68 0 0 1 716 138 L716 200 Z" fill="#0A1626" />
        ...
        <path
          ...
          fill="none" stroke="#33496A" strokeWidth="3"
        />
        ...
        <rect x="592" y="112" width="14" height="88" fill="#0A1626" opacity="0.55" />
        {/* Luminária do hall */}
      ...
      {[
        ...
        <g key={x} transform={`translate(${x} 200) scale(${s})`} opacity="0.9">
          <path d="M-14 0 L14 0 L10 -26 L-10 -26 Z" fill="#1A2E47" />
          <path d="M0 -26 C -16 -46 -14 -66 0 -78 C 14 -66 16 -46 0 -26 Z" fill="#23415F" />
          <path d="M0 -30 C -26 -40 -30 -56 -22 -66 C -6 -60 -2 -44 0 -30 Z" fill="#1C3550" />
          <path d="M0 -30 C 26 -40 30 -56 22 -66 C 6 -60 2 -44 0 -30 Z" fill="#1C3550" />
