    ...
    >
      <defs>
        ...
        <linearGradient id={`${uid}-sweep`} x1="0" y1="0" x2="1" y2="0">
          <stop stopColor="#20D5E8" stopOpacity="0" />
          <stop offset="0.5" stopColor="#20D5E8" stopOpacity="0.14" />
          <stop offset="1" stopColor="#20D5E8" stopOpacity="0" />
        </linearGradient>
      </defs>
      ...
      <line x1="0" y1="198" x2="900" y2="198" stroke="#22364C" strokeWidth="1.4" />
      {[0, 1, 2, 3, 4, 5, 6].map((i) => (
        <line
          key={i}
          x1={-200 + i * 250} y1="260"
      ...
      <g>
        ...
        <rect x="686" y="133" width="24" height="17" rx="1.5" fill="#20D5E8" opacity="0.45" />
        {/* Balcão de atendimento */}
        <rect x="610" y="170" width="112" height="6" fill="#0B1420" opacity="0.5" />
        <line x1="672" y1="118" x2="672" y2="170" stroke="#0B1420" strokeOpacity="0.22" strokeWidth="2" />

        {/* Porta com sinaleiro de acesso */}
        <rect x="730" y="140" width="26" height="60" rx="2" fill="#0A1421" />
        <circle cx="735" cy="172" r="2" fill="#20D5E8" opacity="0.8" />
        <rect x="592" y="198" width="174" height="6" rx="2" fill="#22364C" />
      </g>
      ...
      {/* Poste de iluminação */}
      <g>
        <rect x="536" y="106" width="7" height="94" rx="2" fill="#22364C" />
        <path d="M524 102 Q539 90 554 102 Z" fill="#2B4260" />
        <circle cx="539" cy="103" r="6" fill="#FFE9C4" />
      </g>

      {/* Cancela baixada — acesso controlado */}
      <g>
        <rect x="486" y="140" width="18" height="60" rx="3" fill="#22364C" />
        <rect x="482" y="134" width="26" height="12" rx="3" fill="#2B4260" />
        <circle cx="495" cy="128" r="4.5" fill="#20D5E8" className="nx-scene__pulse" />
        <rect x="238" y="158" width="250" height="11" rx="5" fill="#E8EEF6" />
        {[0, 1, 2, 3, 4, 5, 6].map((i) => (
          <rect key={i} x={250 + i * 34} y="158" width="17" height="11" fill="#0B1420" opacity="0.85" />
        ))}
        <rect x="232" y="146" width="8" height="54" rx="2" fill="#22364C" />
      </g>

      {/* Balizadores marcando a faixa de aproximação */}
      {[300, 344, 388].map((x) => (
        <g key={x}>
          <rect x={x} y="178" width="7" height="22" rx="3" fill="#22364C" />
          <rect x={x} y="180" width="7" height="4" fill="#20D5E8" opacity="0.55" />
        </g>
      ))}
